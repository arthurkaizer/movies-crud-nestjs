...
import { ExceptionI } from 'src/shared/interfaces/http/exception.interface';
import { ExceptionsLoggerService } from 'src/core/lib/logger/exceptions-logger.service';
